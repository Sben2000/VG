				...
				<div class="rollingMenu
					...
					<div class="vgTeam" id="vgTeamLM">
						...
						<div class="adminAccess
							...
							<li><a class="gestionLink" href="../3_admin/gestionTimes/mongoMVC/index.php" target="_blank" id="gestTimesWindowLM">Horaires</a></li>
						</div>
				...
				<div class="allUsers" id="allUsersHM">
					...
					?>">
						...
						<div class="adminAccess<?php
							...
							<li><a href="../3_admin/gestionOffres/mongoMVC/index.php" target="_blank" id="gestTimesWindowTM">Horaires</a></li>
						</div>
					</div>
				</div>
			</ul>
