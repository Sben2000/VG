...
//Function récupérant l'ensembles des données Menus de la DB pour les afficher en options de la liste déroulante
function getMenus(){
    ...
    $sql = ("SELECT * FROM menu GROUP BY titre");
...
function getDataMenu($id){
    ...
    //Récupération de la  DB de l'id et du libellé ou la colonne menu_id match l'ID' requêtée via GET
    $sql = ('SELECT menu_id, titre FROM menu WHERE menu_id =:ID');
    $query =$pdo->prepare($sql);
