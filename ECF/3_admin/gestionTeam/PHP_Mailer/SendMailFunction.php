...
//3)Copier le code affiché dans le github est nommé " A simple Example" ci dessous
        ...
        function sendMail($mail,$subject,$recipient,$body){//mise sous la forme de function qui sera appelée
            ...
            //Server settings
            $mail->SMTPDebug = /*SMTP::DEBUG_SERVER;*/ 0;                 //Enable verbose debug output ->passé à 0 dans notre cas, sinon va nous dire tout ce qui s'est passé pendant la phase d'envoi, sinon mettre à 2
