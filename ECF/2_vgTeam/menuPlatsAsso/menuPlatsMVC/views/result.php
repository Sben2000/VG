...
<div class="feedback">
        <?php
            ...
            if(@$response == "successCreate"){
                ?>
                <!--afficher : -->
                <p class="success" style='color:green'><strong>L' association a été réalisée avec succès!</strong></p>
                ...
                <?php
                                ...
                                ?>
                <!--afficher : -->
                <p class="success" style='color:green'><strong>L'allergène a bien été dissocié du plat !</strong></p>
