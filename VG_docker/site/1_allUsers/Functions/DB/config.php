...
// DB credentials. old méthode avant fichier .env
    ...
    //define('DB_NAME','mycompany');/*Nom de la BDD*/
    // define('DB_PASS','');/**/

//Path
define('__ROOT__', dirname(dirname(__DIR__))); //renvoi à la racine site=> ...\myCompanyENV\site\1_allUsers
//On remonte d'un cran uniquement ici car ce dossier DB est à l'intérieur du dossier Functions pour combler la pb du fichier AJAX à récupérer les mêmes chemins
define('__ROOTER__', dirname(__ROOT__)); //renvoi à la racine site=> ...\myCompanyENV\site
