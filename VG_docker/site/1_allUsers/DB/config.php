...
//     define('DB_HOST', 'host.docker.internal');/*adresse docker IP4: 192.168.1.68 ou host.docker.internal*/
...
//Path
define('__ROOT__', dirname(dirname(__DIR__))); //renvoi à la racine site=> ...\myCompanyENV\site

//Requérir le fichier autoload de dotenv
require_once realpath(__ROOT__."/vendor/autoload.php");//=>check via  echo  __ROOT__."/vendor/autoload.php";
