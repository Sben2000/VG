...
<body>
	...
	<div class="main">
		...
		<div class="multiSectionsCentral">
			...
			<div class="multiSectionsRight">
				<section class="Section smallScreen">
					...
					<div class="SectionContent">
						...
						<div class="product">
							...
							<div class="productRight">
								...
								<input type="submit" name="displayOrderForm" value="Commander ↓ "
									id="displayOrderForm" />
								<input type="submit" name="hideOrderForm" value="Annuler/Masquer ↑"
									id="hideOrderForm" />
							</div>
						</div>
				...
				<section class="Section" id="orderSectionForm">
					<div class="SectionContent">
						...
						<form id="orderForm">
							...
							<div class="formBottom">
								<input type="submit" name="submitOrder" value="Valider la commande" />
							</div>
						</form>
					</div>
				</section>
	...
	<script type="module" src="./JS/orderMenus.js"></script>
</body>
