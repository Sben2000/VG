				...
				<section class="Section">
					<div class="SectionContent">
						...
						<div id="menuContainer">
							...
							<div class="menu">
								<div class="menuLeft">
									<!--cheminPhotoProduit&NomdePhoto affichée à l'intérieur d'un lien correspondant à son url et qui permet de l'afficher et d'avoir le zoom photo-->
									<a href="<?php echo ($photoMenuPath . $menu->photo_menu) ?>">
