...
.then(function(themeID){
	...
	let placeholder = selectedTheme; //document.querySelector(".selectedCategory");
	...
	let	out = `
            ...
            <input type="text" readonly name="themeChoosenID" id="themeChoosenID" value="${themeID[0]['theme_id']}">
            <input type="text" readonly name="themeChoosenName" id="themeChoosenName" value="${themeID[0]['libelle']}">
		`;
