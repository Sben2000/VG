...
<table class="table table-striped">
    ...
    <tbody>
        <?php foreach($themes as $theme): ?>
            ...
            <td><a href="index.php?action=edit&id=<?php echo $theme->theme_id ?>" class="btn btn-success btn-sm">Modifier</a><!--Ajouté afin de modifier une ligne/un libelle, apparaitra autant de fois qu'il y a de libelles (car dans la boucle for each)-->
            ...
            <td><a href="index.php?action=delete&id=<?php echo $theme->theme_id ?>" class="btn btn-danger btn-sm">Supprimer</a><!--Ajouté afin de supprimer une ligne/un libelle, apparaitra autant de fois qu'il y a de libelles (car dans la boucle for each)-->
            </tr>
        <?php endforeach;?>
    </tbody>
