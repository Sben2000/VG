...
$title = 'Liste des libelles de la table "Thème"';

//var_dump($themes);/*voir les valeurs récupérées de la dB */
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($themes as $theme): ?>
                <tr>
                    <td><?= $theme->theme_id ?></td><!--Dans colonne ID-->
                    <td><?= $theme->libelle ?></td><!--Dans colonne libelle-->
                    <div class="actionButtons">
                        ...
                        <div>
                            <td><button class="modifyButton"><a href="index.php?action=edit&id=<?php echo $theme->theme_id ?>">Modifier</a></button><!--Ajouté afin de modifier une ligne/un libelle, apparaitra autant de fois qu'il y a de libelles (car dans la boucle for each)-->
                        </div>
                        ...
                        <div>
                            <td><button class="deleteButton"><a href="index.php?action=delete&id=<?php echo $theme->theme_id ?>">Supprimer</a></button><!--Ajouté afin de supprimer une ligne/un libelle, apparaitra autant de fois qu'il y a de libelles (car dans la boucle for each)-->
                        </div>
                    </div>
                </tr>
            <?php endforeach; ?>
